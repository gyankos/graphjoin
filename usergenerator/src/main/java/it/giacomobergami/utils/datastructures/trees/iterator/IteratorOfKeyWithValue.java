 ...
 */
public class IteratorOfKeyWithValue<Key extends Comparable<Key>,E> implements Iterator<Pair<Key,E>> {

    private TreeMultiMapValuePointerIterator<Key,E> itcoll;
    private Iterator<E> currIt;


    public IteratorOfKeyWithValue(TreeMultiMapValuePointerIterator<Key,E> itcoll) {
        this.itcoll = itcoll;
